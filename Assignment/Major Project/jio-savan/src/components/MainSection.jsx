...
const MainSection = () => {
  ...
  const songs = [
    { src: song13, cover: '/Brabus.jpeg', description: 'Mr Dhatt - Brabus', duration: '3:07' },
    { src: song11, cover: '/untilifoundyou.jpg', description: 'Stephen Sanchez - Until I Found You', duration: '2:55' },
    { src: song12, cover: '/495.jpeg', description: 'Mr Dhatt - 495',duration: '3:07' },
    { src: song14, cover: '/hood.jpeg', description: 'Mr Dhatt - Hood', duration: '3:07' },
    { src: song2, cover: '/lover.jpg', description: 'Diljit Dosanjh - Lover', duration: '3:07' },
    { src: song15, cover: '/jdc.jpeg', description: 'Sultaan - Jatt' , duration: '3:07' },
